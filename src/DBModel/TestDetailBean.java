...
public class TestDetailBean {
	...
	private String  TestDetail_CorrectAnswer;
	private String  TestDetail_Image;
	
	public String getTestDetail_pkey() {
		return TestDetail_pkey;
	}
	public void setTestDetail_pkey(String testDetail_pkey) {
		TestDetail_pkey = testDetail_pkey;
	}
	...
	public String getTestDetail_CorrectAnswer() {
		return TestDetail_CorrectAnswer;
	}
	public void setTestDetail_CorrectAnswer(String testDetail_CorrectAnswer) {
		TestDetail_CorrectAnswer = testDetail_CorrectAnswer;
	}
