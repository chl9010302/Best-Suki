...
public class SqlTest {
	...
	public void insert(int id, String title, String flag) {
		...
		String sql = sb.append("insert into " + table + " values(").append(id + ",").append("'" + title + "','")
	...
	public void update(int id, String title, String flag) {
		StringBuilder sb = new StringBuilder();
		String sql = sb.append("update " + table + " set").append(" title = ").append("'" + title + "',")
				.append(" flag = '").append(flag).append("' where id = ").append(id).append(";").toString();
		try {
			stmt.executeUpdate(sql);
		} catch (SQLException e) {
			// TODO Auto-generated catch block
