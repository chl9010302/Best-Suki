...
public class AddressLoad
{
    ...
    // 반환값 : 에러메시지, null == OK
    public static List<String> find(String s, int p, int l, List<String> v, int[] n)
    {
        ...
        try
        {
            URL url = new URL(
            "http://openapi.epost.go.kr/postal/retrieveNewAdressAreaCdSearchAllService/retrieveNewAdressAreaCdSearchAllService/getNewAddressListAreaCdSearchAll"
            + "?ServiceKey=fPMUq42%2BBSud%2FceC32LjBRBjqb%2BKF0fgvF92ye2JFrg9XCXRoVMv2EtTim9FqpBwFKBA6fhJAIsgfP0aQX7Qvw%3D%3D" // 서비스키
